...
const WaitingScreen = () => {
    ...
    const myPosition = queue.findIndex(p => p.name === patientData.name) + 1;
    const currentTurning = queue[0]?.id || 0;
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                            <div className="text-center md:text-left space-y-4">
                                ...
                                <h2 className="text-8xl lg:text-9xl font-black tracking-tighter text-white">
                                    #{patientData.patient_id?.split('-')[1] || '001'}
                                </h2>
                            ...
                            <div className="w-full md:w-fit space-y-6">
                                <div className="bg-slate-900/80 p-8 rounded-[35px] border border-slate-700 text-center w-full md:w-64">
                                    ...
                                    <p className="text-6xl font-black text-blue-500">{myPosition > 0 ? myPosition - 1 : '--'}</p>
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-slate-800/40 p-10 rounded-[40px] border border-slate-700/50 flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-xl font-bold italic text-slate-300">"{t('now_calling')} #{currentTurning}"</p>
                            </div>
                        </div>
                    </div>
                </div>
